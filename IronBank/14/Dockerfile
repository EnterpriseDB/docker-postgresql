...
RUN dnf update -y --nodocs && \
    dnf clean all && \
	rpm --import /tmp/RPM-GPG-KEY-PGDG-14 && \
	dnf -y reinstall \
	tar \
	glibc-common  && \
	...
	redhat-rpm-config \
	rsync \
	/tmp/postgresql14-14.4-1PGDG.rhel8.x86_64.rpm \
	/tmp/postgresql14-contrib-14.4-1PGDG.rhel8.x86_64.rpm \
	/tmp/postgresql14-server-14.4-1PGDG.rhel8.x86_64.rpm \
	/tmp/postgresql14-libs-14.4-1PGDG.rhel8.x86_64.rpm \
	/tmp/pgaudit16_14-1.6.2-1.rhel8.x86_64.rpm \
	&& rm -rf /var/cache/dnf
