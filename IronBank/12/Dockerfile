...
COPY ./RPM-GPG-KEY-PGDG-12 \
	./postgresql12-12.11-1PGDG.rhel8.x86_64.rpm \
	./postgresql12-contrib-12.11-1PGDG.rhel8.x86_64.rpm \
	./postgresql12-server-12.11-1PGDG.rhel8.x86_64.rpm \
	./postgresql12-libs-12.11-1PGDG.rhel8.x86_64.rpm \
	./pgaudit14_12-1.4.3-1.rhel8.x86_64.rpm \
	./requirements.txt \
	./*.whl \
	./*.tar.gz \
	/tmp/
...
RUN dnf update -y --nodocs && \
    dnf clean all && \
	rpm --import /tmp/RPM-GPG-KEY-PGDG-12 && \
	dnf -y reinstall \
	tar \
	glibc-common  && \
	...
	redhat-rpm-config \
	rsync \
	/tmp/postgresql12-12.11-1PGDG.rhel8.x86_64.rpm \
	/tmp/postgresql12-contrib-12.11-1PGDG.rhel8.x86_64.rpm \
	/tmp/postgresql12-server-12.11-1PGDG.rhel8.x86_64.rpm \
	/tmp/postgresql12-libs-12.11-1PGDG.rhel8.x86_64.rpm \
	/tmp/pgaudit14_12-1.4.3-1.rhel8.x86_64.rpm \
	&& rm -rf /var/cache/dnf
...
HEALTHCHECK --interval=5s --timeout=3s CMD /usr/pgsql-12/bin/pg_isready -U postgres
USER ${PG_USER_ID}
