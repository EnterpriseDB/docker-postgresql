...
RUN --mount=type=secret,id=cs_script,target=/run/secrets/cs_script.sh \
	...
	yum -y --setopt=tsflags=nodocs install \
		postgresql10-10.21-1PGDG.rhel8 \
		postgresql10-contrib-10.21-1PGDG.rhel8 \
		postgresql10-server-10.21-1PGDG.rhel8 \
		postgresql10-libs-10.21-1PGDG.rhel8 \
		pgaudit12_10 \
	; \
