...
RUN --mount=type=secret,id=cs_script,target=/run/secrets/cs_script.sh \
	...
	yum -y --setopt=tsflags=nodocs install \
		postgresql14-14.4-1PGDG.rhel8 \
		postgresql14-contrib-14.4-1PGDG.rhel8 \
		postgresql14-server-14.4-1PGDG.rhel8 \
		postgresql14-libs-14.4-1PGDG.rhel8 \
		pgaudit16_14 \
	; \
