...
RUN --mount=type=secret,id=cs_script,target=/run/secrets/cs_script.sh \
	...
	yum -y --setopt=tsflags=nodocs install \
		postgresql11-11.16-1PGDG.rhel8 \
		postgresql11-contrib-11.16-1PGDG.rhel8 \
		postgresql11-server-11.16-1PGDG.rhel8 \
		postgresql11-libs-11.16-1PGDG.rhel8 \
		pgaudit13_11 \
	; \
